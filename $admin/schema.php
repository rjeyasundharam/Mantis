...
$g_upgrade[46] = array( 'CreateTableSQL', array( db_get_table( 'user' ), "
	...
	division_id						I		UNSIGNED NULL ,
	department_id					I		UNSIGNED NULL ,
...
$g_upgrade[210] = array( 'CreateTableSQL', array( db_get_table( 'division' ), "
	division_id				I		UNSIGNED NOTNULL PRIMARY AUTOINCREMENT,
	division				C(64)	NOTNULL DEFAULT \" '' \"",
	$t_table_options
	) );

$g_upgrade[211] = array( 'CreateTableSQL', array( db_get_table( 'department' ), "
	department_id			I		UNSIGNED NOTNULL PRIMARY AUTOINCREMENT,
	department				C(64)	NOTNULL DEFAULT \" '' \",
	division_id			I		UNSIGNED NOTNULL",
	$t_table_options
	) );
