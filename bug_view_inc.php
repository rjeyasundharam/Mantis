...
if( $t_show_reporter || $t_show_handler || $t_show_due_date ) {
	...
	if( $t_show_reporter ) {
		...
		echo '<th class="bug-reporter category">', lang_get( 'division' ), '</th>';
		echo '<td class="bug-reporter">';
		echo user_get_division( $t_bug->reporter_id);
		echo '</td>';
		
		echo '<th class="bug-reporter category">', lang_get( 'department' ), '</th>';
		echo '<td class="bug-reporter">';
		echo user_get_department( $t_bug->reporter_id);
		echo '</td>';
	...
	if( $t_show_handler ) {
		...
		echo '<th class="bug-assigned-to category">', lang_get( 'division' ), '</th>';
		echo '<td class="bug-assigned-to">';
		echo user_get_division( $t_bug->handler_id);
		echo '</td>';

		echo '<th class="bug-assigned-to category">', lang_get( 'department' ), '</th>';
		echo '<td class="bug-assigned-to">';
		echo user_get_department( $t_bug->handler_id);
		echo '</td>';
