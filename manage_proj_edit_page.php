	...
	<table class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th><?php echo lang_get( 'division' ) ?></th>
				<th><?php echo lang_get( 'department' ) ?></th>
...
?>
			<tr>
				...
				<td>
				<?php
					echo user_get_division( $t_user['id'] );
				?>
				</td>
				
				<td>
				<?php
					echo user_get_department( $t_user['id'] );
				?>
				</td>
...
<div class="col-md-12 col-xs-12">
	...
	<div class="widget-box widget-color-blue2">
		...
		<fieldset>
			...
			<input type="hidden" id="project_id" name="project_id" value="<?php echo $f_project_id ?>" />
			...
			<tr>
				...
				<td>
					<select name="division_id" id="project-edit-division" class="input-sm" required>
						<?php echo  get_project_division_list(); ?>
					</select>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<select name="department_id" required id="project-edit-department" class="input-sm">
						<?php echo get_edit_department_list($t_user['department_id'],$t_user['division_id']); ?>
					</select>
				</td>
			</tr>
