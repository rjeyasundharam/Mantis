...
$f_division		= gpc_get_string( 'division_id', '' );
$f_department		= gpc_get_string( 'department_id', '' );
...
$f_division	= trim( $f_division );
$f_department	= trim( $f_department );
...
$c_division= $f_division;
$c_department= $f_department;
...
if( $f_protected && $t_old_protected ) {
	$t_query = 'UPDATE {user}
			SET username=' . db_param() . ',division_id=' . db_param() . ',department_id=' . db_param() . ', email=' . db_param() . ',
				protected=' . db_param() . ', realname=' . db_param() . '
			WHERE id=' . db_param();
	$t_query_params = array( $c_username,$c_division,$c_department, $c_email, $c_protected, $c_realname, $c_user_id );
	...
	$t_query = 'UPDATE {user}
			SET username=' . db_param() .',division_id=' . db_param() . ',department_id=' . db_param() . ', email=' . db_param() . ',
				...
				protected=' . db_param() . ', realname=' . db_param() . '
			WHERE id=' . db_param();
	$t_query_params = array( $c_username,$c_division,$c_department, $c_email, $c_access_level, $c_enabled, $c_protected, $c_realname, $c_user_id );
}
