...
<?php if( $t_show_handler ) { ?>
	...
	<tr>
		<th class="category">
			<label><?php echo lang_get( 'division' ) ?></label>
		</th>
		<td>
			<select name="division" id="division" class="input-sm">
	...
	<tr>
		<th class="category">
			<label><?php echo lang_get( 'department' ) ?></label>
		</th>
		<td>
			<select name="department" id="department" class="input-sm">
				<option>--None--</option>
			</select>
		</td>
	</tr>
