...
define( 'ERROR_DIVISION_NOT_FOUND', 'Division Not found' );
define( 'ERROR_DEPARTMENT_NOT_FOUND', 'Department Not found' );
define( 'ERROR_DEPARTMENT_DUPLICATE', 'Department duplicate' );
define( 'ERROR_DEPARTMENT_DELETE', 'Department delete' );
define( 'ERROR_DIVISION_DUPLICATE', 'Division duplicate' );
define( 'ERROR_DIVISION_DELETE', 'Division delete' );
define( 'ERROR_PROJECT_USER_DUPLICATE', 'Project User duplicate' );