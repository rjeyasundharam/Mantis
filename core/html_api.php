...
function print_manage_menu( $p_page = '' ) {
	...
	if( access_has_global_level( config_get( 'manage_user_threshold' ) ) ) {
		...
		$t_pages['manage_division_page.php'] = array( 'url'   => 'manage_division_page.php', 'label' => 'manage_division_link' );
		$t_pages['manage_department_page.php'] = array( 'url'   => 'manage_department_page.php', 'label' => 'manage_department_link' );
	}
