	...
	<form id="edit-user-form" method="post" action="manage_user_update.php">
		...
		<fieldset>
			...
			<tr>
				...
				<td>
					<select name="division_id" id="division" class="input-sm" required>
						<?php echo  get_edit_division_list($t_user['division_id']); ?>
					</select>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<select name="department_id" id="department" class="input-sm" required>
