...
$u_division_id = user_get_division_id( $u_id );
$u_department_id = user_get_department_id( $u_id );
	...
	<div class="widget-body">
		...
		<fieldset>
			...
			<tr>
				...
				<td>
					<select name="division_id" id="division" class="input-sm">
						<?php echo  get_edit_division_list($u_division_id); ?>
					</select>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<select name="department_id" id="department" class="input-sm">
						<?php echo  get_edit_department_list($u_department_id,$u_division_id); ?>
					</select>
				</td>
			</tr>
